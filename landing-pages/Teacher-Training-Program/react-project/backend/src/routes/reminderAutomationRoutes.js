 ...
 * Concrete items due within the next 24 hours, across all 5 categories,
 * plus registration approvals waiting on the admin.
 * Admin only.
 */
 ...
 * within the next 24 hours (same list as GET /upcoming).
 ...
 * admin trigger (e.g. a "Send Reminders Now" button).
 * Admin only.
 */
