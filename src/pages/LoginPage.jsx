...
function LoginForm({ onLogin, onGoRegister, onGoForgot }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setToast({ msg: error.message || "Incorrect credentials. Please try again.", type: "error" });
    }
  };
...
function RegisterForm({ onBack }) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      setToast({ msg: error.message || "Registration failed. Please try again.", type: "error" });
    }
  };
