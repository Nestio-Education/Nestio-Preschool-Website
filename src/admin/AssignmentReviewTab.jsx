  ...
  return (
    <div style={{ animation: "fadeIn 0.3s ease" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(130px,1fr))", gap: 12, marginBottom: 20 }}>
        {[
          { icon: "PD", label: "Pending",      val: pending,  color: "#f59e0b", bg: "#fef9c3" },
          { icon: "UR", label: "Under Review", val: underRev, color: "#3b82f6", bg: "#dbeafe" },
          { icon: "RV", label: "Reviewed",     val: reviewed, color: "#10b981", bg: "#d1fae5" },
          { icon: "RS", label: "Revision",     val: revision, color: "#ef4444", bg: "#fee2e2" },
          { icon: "AP", label: "Approved",     val: approved, color: "#7c3aed", bg: "#ede9fe" },
        ].map((k, i) => (
